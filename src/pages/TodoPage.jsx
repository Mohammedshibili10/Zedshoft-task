        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tasks.map((task, index) => (
            ...
            >
              <Link to={`/tododetails`}>
                <div
                  className={`backdrop-blur-lg bg-white/60 border border-gray-200 p-5 rounded-3xl shadow hover:shadow-2xl transition ${
                    task.completed ? "border-t-4 border-blue-400" : ""
                  }`}
                >
                    ...
                    <div className="flex items-center gap-1">
                      <span
                        className={`w-2 h-2 rounded-full ${
                          task.completed ? "bg-blue-500" : "bg-gray-400"
                        }`}
                      ></span>
